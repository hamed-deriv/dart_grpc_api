...
final $typed_data.Uint8List itemDescriptor = $convert.base64Decode(
    'CgRJdGVtEg4KAmlkGAEgASgFUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEh8KC2NhdGVnb3J5X2lkGAMgASgFUgpjYXRlZ29yeUlk');
...
const AllItemsOfCategory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.Item', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List allItemsOfCategoryDescriptor = $convert.base64Decode(
    'ChJBbGxJdGVtc09mQ2F0ZWdvcnkSHwoLY2F0ZWdvcnlfaWQYASABKAVSCmNhdGVnb3J5SWQSGwoFaXRlbXMYAiADKAsyBS5JdGVtUgVpdGVtcw==');
