...
class AllItemsOfCategory extends $pb.GeneratedMessage {
  ...
  factory AllItemsOfCategory.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AllItemsOfCategory.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AllItemsOfCategory copyWith(void Function(AllItemsOfCategory) updates) =>
      super.copyWith((message) => updates(message as AllItemsOfCategory))
          as AllItemsOfCategory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AllItemsOfCategory create() => AllItemsOfCategory._();
  AllItemsOfCategory createEmptyInstance() => create();
  static $pb.PbList<AllItemsOfCategory> createRepeated() =>
      $pb.PbList<AllItemsOfCategory>();
  @$core.pragma('dart2js:noInline')
  static AllItemsOfCategory getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AllItemsOfCategory>(create);
